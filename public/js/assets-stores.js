...
const ENDPOINT_MAP = {
  ...
  'units.list':                      () => '/api/assets/units',
  'units.create':                    () => '/api/assets/units',
  'units.read':                      (p) => `/api/assets/units/${p.unit_id}`,
  'units.update':                    (p) => `/api/assets/units/${p.unit_id}`,
  'units.archive':                   (p) => `/api/assets/units/${p.unit_id}/archive`,
  'unit-residents.list':             () => '/api/assets/unit-residents',
  'unit-residents.create':           () => '/api/assets/unit-residents',
  'unit-residents.read':             (p) => `/api/assets/unit-residents/${p.unit_resident_id}`,
  'unit-residents.update':           (p) => `/api/assets/unit-residents/${p.unit_resident_id}`,
  ...
  'lease-charges.list':              () => '/api/assets/lease-charges',
  'lease-charges.create':            () => '/api/assets/lease-charges',
  'lease-charges.read':              (p) => `/api/assets/lease-charges/${p.charge_id}`,
  'lease-charges.update':            (p) => `/api/assets/lease-charges/${p.charge_id}`,
  'lease-charges.archive':           (p) => `/api/assets/lease-charges/${p.charge_id}/archive`,
  'cost-categories.list':            () => '/api/assets/cost-categories',
  'expense-bookings.list':           () => '/api/assets/expense-bookings',
  'expense-bookings.create':         () => '/api/assets/expense-bookings',
  'expense-bookings.read':           (p) => `/api/assets/expense-bookings/${p.booking_id}`,
  'expense-bookings.update':         (p) => `/api/assets/expense-bookings/${p.booking_id}`,
  'expense-bookings.archive':        (p) => `/api/assets/expense-bookings/${p.booking_id}/archive`,
  'allocation-rules.list':           () => '/api/assets/allocation-rules',
  'allocation-rules.create':         () => '/api/assets/allocation-rules',
  ...
  'allocation-rule-shares.list':     () => '/api/assets/allocation-rule-shares',
  'allocation-rule-shares.create':   () => '/api/assets/allocation-rule-shares',
  'allocation-rule-shares.read':     (p) => `/api/assets/allocation-rule-shares/${p.share_id}`,
  'allocation-rule-shares.update':   (p) => `/api/assets/allocation-rule-shares/${p.share_id}`,
  'allocation-rule-shares.archive':  (p) => `/api/assets/allocation-rule-shares/${p.share_id}/archive`,
  'meters.list':                     () => '/api/assets/meters',
  ...
  'meter-readings.list':             () => '/api/assets/meter-readings',
  'meter-readings.create':           () => '/api/assets/meter-readings',
  'meter-readings.read':             (p) => `/api/assets/meter-readings/${p.reading_id}`,
  'meter-readings.update':           (p) => `/api/assets/meter-readings/${p.reading_id}`,
  'meter-readings.bulk':             () => '/api/assets/meter-readings/bulk',
